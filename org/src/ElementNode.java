 ...
 *
 */
public class ElementNode extends com.puppycrawl.tools.checkstyle.xpath.AbstractNode {
    ...
    private final com.puppycrawl.tools.checkstyle.xpath.AbstractNode parent;
     ...
     * @return siblings
     */
    private List<com.puppycrawl.tools.checkstyle.xpath.AbstractNode> getFollowingSiblings() {
        final List<com.puppycrawl.tools.checkstyle.xpath.AbstractNode> siblings = parent.getChildren();
     ...
     * @return siblings
     */
    private List<com.puppycrawl.tools.checkstyle.xpath.AbstractNode> getPrecedingSiblings() {
        final List<com.puppycrawl.tools.checkstyle.xpath.AbstractNode> siblings = parent.getChildren();
